...
/**
 * Badly named, this class compares objects by first converting them to
 * <tt>String</tt>s using the <tt>toString</tt> method.
 */
public class DefaultComparator implements Comparator {
    ...
    /**
     * Compares two Objects <b>using the <tt>toString()</tt> method</b> as the
     * value of each object to compare.
     *
     * @param o1 the first object to be compared
     * @param o2 the second object to be compared
     * @return 0 if a and b are equal, -1 if a <lt> b, 1 if a <gt> b
     */
