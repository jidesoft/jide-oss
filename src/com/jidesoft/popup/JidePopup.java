    ...
    protected void installBorder() {
        if (getPopupBorder() != null) {
            ...
            if (isDetached()) {
                ...
                _window.setBorder(UIManager.getBorder("Resizable.resizeBorder"));
            }
            else {
                if (isResizable()) {
                ...
                _window.setBorder(UIManager.getBorder("PopupMenu.border"));
            }
        }
    }
