...
import com.jidesoft.plaf.basic.ThemeState;
...
//        childToCenter.setLocation((screenDim.width - frameDim.width) >> 1, (screenDim.height - frameDim.height) >> 1);
    ...
    public static int getButtonState(AbstractButton b) {
        ...
        if (!model.isEnabled()) {
            if (model.isSelected()) {
                return ThemeState.STATE_DISABLE_SELECTED;
            }
            else {
                return ThemeState.STATE_DISABLE;
            }
        }
        else if (b.hasFocus() && b.isFocusPainted()) {
            if (model.isSelected()) {
                return ThemeState.STATE_PRESSED;
            }
            else {
                return ThemeState.STATE_ROLLOVER;
            }
        }
            ...
            if (model.isSelected()) {
                return ThemeState.STATE_PRESSED; // should be rollover selected
            }
            else {
                return ThemeState.STATE_ROLLOVER;
            }
            ...
            return ThemeState.STATE_SELECTED;
        }
        return ThemeState.STATE_DEFAULT;
    }
...
//</syd_0002>
    ...
    public static boolean isAncestorOfFocusOwner(Component component) {
        ...
        Component focusOwner = DefaultFocusManager.getCurrentManager().getPermanentFocusOwner();
