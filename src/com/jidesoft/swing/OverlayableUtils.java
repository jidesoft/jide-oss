...
public class OverlayableUtils {
     ...
     * This method will find the first overlayable that contains the component or its parents.
     *
     ...
     * Different from {@link #getOverlayable(javax.swing.JComponent)}, this method
     * will find the all overlayables that contain the component or its parents.
     *
     * @param component the component
     ...
     * </code></pre>
     *
     * @param component the component that has an overyable.
     */
     ...
     * <li>{@link OverlayableIconsFactory#INFO}
     * <li>{@link OverlayableIconsFactory#QUESTION}
     * </ul>
     *
