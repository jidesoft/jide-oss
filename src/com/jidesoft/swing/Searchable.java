...
public abstract class Searchable {
    ...
    private class DefaultSearchPopup extends SearchPopup {
        ...
        private void initComponents(String text) {
            ...
            setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(UIManager.getColor("controlShadow"), 1),
    ...
    private void keyTypedOrPressed(KeyEvent e) {
