        ...
        switch (type) {
            case HSPLIT_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.hsplit");
                    if (icon == null)
            ...
            case VSPLIT_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.vsplit");
                    if (icon == null)
            ...
            case DRAG_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.drag");
                    if (icon == null)
            ...
            case DRAG_STOP_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.dragStop");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case DRAG_TEXT_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.dragText");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case DRAG_TEXT_STOP_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.dragTextStop");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case NORTH_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.north");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case SOUTH_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.south");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case EAST_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.east");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case WEST_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.west");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case TAB_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.tab");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case FLOAT_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.float");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case VERTICAL_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.vertical");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case HORIZONTAL_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.horizontal");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
            ...
            case DELETE_CURSOR: {
                if (bestSize.width != 0 && maxColor > 3) {
                    ImageIcon icon = (ImageIcon) UIManager.getIcon("Cursor.delete");
                    if (icon == null)
                        return Cursor.getDefaultCursor();
