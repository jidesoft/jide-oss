...
/**
 * ButtonPanel can have a collection of buttons. And it will make all buttons to
 * have the same size to make them looks better.
 *
...
public class ButtonPanel extends JPanel {
    ...
    /**
     * Constructs a new <code>ButtonPanel</code> with the default horizontal
    ...
    /**
     * Constructs a new <code>ButtonPanel</code> with the given horizontal
     * spacing and alignment.
     *
     * @param spacing   The gridSize of the gap (in pixels) to place between buttons
     *                  horizontally.
     * @param alignment the alignment of the buttons. It can be one of <code>SwingConstants.LEFT</code> or
     *                  <code>SwingConstants.RIGHT</code> or <code>SwingConstants.TOP</code> or
     *                  <code>SwingConstants.BOTTOM</code>.
     ...
     * @param pos    position at which to add the button. The value 0 denotes
     ...
     *
     * @param position position of the button to remove, where 0 denotes the
     *                 first position.
     */
    ...
    /**
     * Gets the button at the specified position in the
    ...
    /**
     * Gets the actual panel that has the buttons. We expose this method so
     * that user can customize the panel such as the background. Please don't
     * try to add non-button component to it.
     *
