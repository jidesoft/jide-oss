...
/**
 * <code>ResizablePanel</code> is a panel that can be resized. You can resize
 * it from any of the four corners or four sides.
 */
public class ResizablePanel extends JPanel implements ResizableSupport {
    private Resizable _resizable;

    /**
     * Creates a new <code>ResizablePanel</code> with a double buffer
     * and a flow layout.
     */
    ...
    /**
     * Creates a new <code>ResizablePanel</code> with <code>FlowLayout</code>
    ...
    /**
     * Creates a new <code>ResizablePanel</code> with the specified layout manager and buffering
     * strategy.
     *
     * @param layout           the LayoutManager to use
     * @param isDoubleBuffered a boolean, true for double-buffering, which
    ...
    /**
     * Creates the Resizable. Subclass class can override this method to create its own Resizable
     * and tweak some options.
     *
     * @return Resizable.
     */
     ...
     * in UIManager.getBorder("Resizable.resizeBorder")).
     */
