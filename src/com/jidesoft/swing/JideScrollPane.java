...
public class JideScrollPane extends JScrollPane implements JideScrollPaneConstants {
    ...
    public void setRowFooter(JViewport rowFooter) {
        ...
        if (null != rowFooter) {
            add(rowFooter, JideScrollPaneConstants.ROW_FOOTER);
        }
        else if (null != old) {
            remove(old);
        }
    ...
    public void setColumnFooter(JViewport columnFooter) {
        ...
        if (null != columnFooter) {
            add(columnFooter, JideScrollPaneConstants.COLUMN_FOOTER);
        }
        else if (null != old) {
            remove(old);
        }
    ...
    public Component getScrollBarCorner(String key) {
        ...
        if (key.equals(JideScrollPaneConstants.HORIZONTAL_LEADING)) {
            key = isLeftToRight ? JideScrollPaneConstants.HORIZONTAL_LEFT : JideScrollPaneConstants.HORIZONTAL_RIGHT;
        }
        else if (key.equals(JideScrollPaneConstants.HORIZONTAL_TRAILING)) {
            key = isLeftToRight ? JideScrollPaneConstants.HORIZONTAL_RIGHT : JideScrollPaneConstants.HORIZONTAL_LEFT;
        }

        if (key.equals(JideScrollPaneConstants.HORIZONTAL_LEFT)) {
            return _hLeft;
        }
        else if (key.equals(JideScrollPaneConstants.HORIZONTAL_RIGHT)) {
            return _hRight;
        }
        else if (key.equals(JideScrollPaneConstants.VERTICAL_BOTTOM)) {
            return _vBottom;
        }
        else if (key.equals(JideScrollPaneConstants.VERTICAL_TOP)) {
            return _vTop;
        }
        else {
            return null;
