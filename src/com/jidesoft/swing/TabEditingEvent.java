...
public class TabEditingEvent extends AWTEvent {
     ...
     */
    public static final int TAB_EDITING_STARTED = AWTEvent.RESERVED_ID_MAX + 1300;
    ...
    /**
     * The new title after tab editing. If the event is to indicate the tab editing is started, this will be null.
