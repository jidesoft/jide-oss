...
//    private static final String SUBSTANCE_LNF_PREFIX = "org.jvnet.substance.skin";
    ...
    /**
     * A style that you can use with {@link #installJideExtension(int)} method. This style mimics the visual style of Eclipse 2.x for the toolbars, menus and dockable windows.
     * <p/>
    ...
    /**
     * A style that you can use with {@link #installJideExtension(int)} method. This style is created by Xerto (http://www.xerto.com) which is used in their Imagery product.
     * <p/>
    ...
    /**
     * A style that you can use with {@link #installJideExtension(int)} method. This style mimics the visual style of Eclipse 3.x for the toolbars, menus and dockable windows.
     * <p/>
    ...
    /**
     * A style that you can use with {@link #installJideExtension(int)} method. This style mimics the visual style of Microsoft Office2007 for the toolbars, menus and dockable windows.
     * <p/>
    ...
    /**
     * Sets the default style. If you call this method to set a default style, {@link #installJideExtension()} will use it as the default style.
     *
