...
//        map.setParent(audioMap);
    ...
    private void paintCheckBox(JMenuItem b, Graphics g, Icon checkIcon) {
        ...
        if (b instanceof JCheckBoxMenuItem)
            selected = ((JCheckBoxMenuItem) b).isSelected();
        else if (b instanceof JRadioButtonMenuItem)
            selected = ((JRadioButtonMenuItem) b).isSelected();
        if (selected) {
            if (b.getIcon() == null) {
...
*/
    ...
    private class MenuKeyHandler implements MenuKeyListener {
        ...
        public void menuKeyTyped(MenuKeyEvent e) {
            if (DEBUG) {
                System.out.println("in EclipseMenuItemUI.menuKeyTyped for " + menuItem.getText());
            }
        ...
        public void menuKeyPressed(MenuKeyEvent e) {
            if (DEBUG) {
                System.out.println("in EclipseMenuItemUI.menuKeyPressed for " + menuItem.getText());
            }
        }
